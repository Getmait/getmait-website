      ...
      <main className="px-6 pb-32">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-white border border-slate-100 rounded-3xl shadow-sm px-10 md:px-16 py-12">
            ...
            <div id="s1"><SectionHeader num="1" title="Generelt" />
            ...
            <div id="s2"><SectionHeader num="2" title="Ydelser" />
            ...
            <div id="s3"><SectionHeader num="3" title="Priser og betaling" />
            ...
            <div id="s4"><SectionHeader num="4" title="Abonnement og opsigelse" />
            ...
            <div id="s5"><SectionHeader num="5" title="Kundens forpligtelser" />
            ...
            <div id="s6"><SectionHeader num="6" title="Immaterielle rettigheder" />
            ...
            <div id="s7"><SectionHeader num="7" title="Ansvarsbegrænsning" />
              <div className="grid grid-cols-2 gap-3 mb-5">
                {[
            ...
            <div id="s8"><SectionHeader num="8" title="Fortrolighed" />
            ...
            <div id="s9"><SectionHeader num="9" title="Lovvalg og værneting" />
