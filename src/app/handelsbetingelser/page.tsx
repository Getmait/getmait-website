        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white border border-slate-100 rounded-3xl shadow-sm px-10 md:px-14 py-14">
            <div className="space-y-10 text-[15px] text-slate-600 leading-relaxed">
              ...
              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">1. Generelt</h2>
                <p className="mb-3">Disse handelsbetingelser gælder for alle aftaler indgået mellem GetMait ApS (herefter "Getmait") og kunden om levering af AI-baserede voice- og automatiseringsydelser. Ved accept af et tilbud eller indgåelse af abonnementsaftale accepterer kunden samtidig nærværende betingelser i deres helhed.</p>
              ...
              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">2. Ydelser</h2>
                <p className="mb-3">Getmait leverer AI-drevne voice-løsninger til restauranter og lignende virksomheder, herunder automatisk opkaldshåndtering og ordremodtagelse via Voice AI, intelligent mersalg og kundedialog, realtids-dashboard til opfølgning og analyse, integration til eksisterende POS- og bestillingssystemer (afhænger af pakke) samt løbende opdatering og optimering af AI-modellen.</p>
              ...
              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">3. Priser og betaling</h2>
                <p className="mb-3">Priser aftales individuelt og fremgår af det underskrevne tilbud eller abonnementsaftalen. Alle priser er ekskl. moms, medmindre andet er angivet. Fakturering sker månedsvis forud med betalingsbetingelse 8 dage netto.</p>
              ...
              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">4. Abonnement og opsigelse</h2>
                <p className="mb-3">Abonnementsaftalen løber som udgangspunkt med en bindingsperiode på 3 måneder fra aktivering, hvorefter aftalen kan opsiges løbende med 30 dages varsel til udgangen af en måned. Opsigelse skal ske skriftligt pr. e-mail til <a href="mailto:kontakt@getmait.dk" className="text-mait font-semibold hover:underline">kontakt@getmait.dk</a>.</p>
              ...
              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">5. Kundens forpligtelser</h2>
                <p className="mb-3">Kunden er ansvarlig for at stille nødvendige tekniske oplysninger til rådighed for opsætning (fx telefonnumre, menukort, åbningstider), at sikre at de informationer der gives til Getmait er korrekte og opdaterede, at informere egne kunder om at opkald kan blive håndteret af en AI-stemme i det omfang lovgivningen kræver dette, samt at anvende platformen i overensstemmelse med gældende dansk ret og EU-regulering.</p>
              </section>

              <div className="border-t border-slate-100" />

              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">6. Immaterielle rettigheder</h2>
              ...
              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">7. Ansvarsbegrænsning</h2>
                <p className="mb-3">Getmaits ansvar over for kunden er i alle tilfælde begrænset til det beløb, kunden har betalt i de seneste 3 måneder forud for skadens opståen. Getmait er ikke ansvarlig for indirekte tab, driftstab, tabt avance eller tab som følge af tredjeparters handlinger.</p>
              ...
              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">8. Fortrolighed</h2>
              ...
              <section>
                <h2 className="text-base font-black uppercase tracking-widest text-slate-400 mb-3">9. Lovvalg og værneting</h2>
              ...
              <section>
                ...
                <p>Spørgsmål til disse handelsbetingelser rettes til GetMait ApS, Tarphagevej 34, 6700 Esbjerg, CVR 12345678 · <a href="mailto:kontakt@getmait.dk" className="text-mait font-semibold hover:underline">kontakt@getmait.dk</a>.</p>
              </section>
